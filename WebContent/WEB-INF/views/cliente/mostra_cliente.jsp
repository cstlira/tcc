...
<div class="container">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title"> Editando Cliente <strong> ${cliente.nome} </strong> </h3>
			</div>
			<br /> <br />
			...
			<form:form class="form-horizontal"
				action="AtualizaCliente" modelAttribute="cliente"
				method="post" id="cadastro">
				<fieldset>
				
				
				<c:if test="${not empty msgClienteAtualizado}">
				<div class="alert alert-success col-md-7 col-md-offset-3">
  				...
  				Cliente atualizado com sucesso.
					...
					<div class="form-group">
						...
						<button type="button" class="btn btn-primary btn-block" id="toggle"> Editar cliente</button>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<c:if test="${not empty cliente.cpf}">Nome*</c:if>
						<c:if test="${not empty cliente.cnpj}">Razão Social*</c:if>
						</label>
						<div class="col-md-3">
					...
					<div class="form-group">
						...
						<div class="col-md-3">
							<form:input path="endereco.cep" name="cep"
								type="text" placeholder="" class="form-control input-md" id="cep" />
					...
					<div class="form-group">
						<label class="col-md-3 control-label" for="endereco.referencia">Ponto de Referência:</label>
						<div class="col-md-4">
					...
					<div class="form-group">
						<label class="col-md-3 control-label" for="ativo">Status do Cliente *</label>
						<div class="col-md-3">
							<form:select path="ativo" id="ativo" name="ativo" class="form-control">
								<option value="0"  <c:if test="${cliente.ativo == false}">selected</c:if> >Inativo</option>
								<option value="1" <c:if test="${cliente.ativo == true}">selected</c:if>>Ativo</option>
							</form:select>
						</div>
					</div>
					
					<div class="form-group">
						<label class="col-md-3 control-label" for="dataCadastro">Data de Cadastro:*</label>
						<div class="col-md-4">
						<p class="control-label" style="text-align:left !important;">
						<fmt:formatDate value="${cliente.dataCadastro}" pattern="dd/MM/yyyy HH:mm:ss" />
						</p>
						</div>
					</div>
