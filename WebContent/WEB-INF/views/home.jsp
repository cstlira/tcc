...
<body>
  <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <c:out value="${usuarioLogado.nome}" /> <b class="caret"></b></a>
                ...
                <div class="row">
                    ...
                    <c:if test="${not empty cliente.nome }">
                            <div class="alert alert-success alert-dismissable">
                                ...
                                Cliente <strong> ${cliente.nome} </strong> adicionado com sucesso! 
                            </div>
					</c:if>

                        <h1 class="page-header">
                            Início <small>Estatísticas do Sistema</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
  ...
  <script type="text/javascript">
    function call(servlet, method, divId) {
		var method = method;
		var servlet = servlet;
		var divId = divId;
        ...
        $.ajax({
            ...
            success: function(response) {
            	...
            	//alert("Chamando "+servlet+ " com o método "+ method+ " na div "+divId)
               	$(divId).html(response); 
            }
        });
    }
